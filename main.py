...
from base_functions import find_file_in_directory, load_users

from stock_order_manager import StockOrderManager

def run_stock_order_manager(username, password, stock_symbol, request_per_sec, broker_no, request_owner, order_quantity, previous_ltp):
...
if __name__ == "__main__":
    ...
    users =load_users(find_file_in_directory('users.txt'))
